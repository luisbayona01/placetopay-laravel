        ...
        <div class="content">
            ...
            <div class="links">
                <a href="{{ url('/formulario') }}">
                    <i class="fas fa-shopping-cart"></i> Formulario de compra
                </a>
                <a href="{{ url('/transacciones') }}">
                    <i class="fas fa-clipboard-list"></i> Pagos
                </a>
                <a href="https://github.com/fermius/placetopay-laravel" target="_blank">
